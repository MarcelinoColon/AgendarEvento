...
namespace AgendarEvento.PruebaDataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[clientes] SET [nombre] = @nombre WHERE (([clienteid] = @Original_cl" +
                "ienteid) AND ([nombre] = @Original_nombre));\r\nSELECT clienteid, nombre FROM clie" +
                "ntes WHERE (clienteid = @clienteid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AgendarEvento.Properties.Settings.Default.PruebaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT clienteid, nombre FROM dbo.clientes";
        ...
        public virtual int Fill(PruebaDataSet.clientesDataTable dataTable) {
        ...
        public virtual PruebaDataSet.clientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PruebaDataSet.clientesDataTable dataTable = new PruebaDataSet.clientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PruebaDataSet.clientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_clienteid, string Original_nombre) {
        ...
        public virtual int Update(string nombre, int Original_clienteid, string Original_nombre, int clienteid) {
            if ((nombre == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_clienteid));
            if ((Original_nombre == null)) {
                throw new global::System.ArgumentNullException("Original_nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, int Original_clienteid, string Original_nombre) {
            return this.Update(nombre, Original_clienteid, Original_nombre, Original_clienteid);
        }
    }
